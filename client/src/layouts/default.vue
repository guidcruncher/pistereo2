...
<template>
  ...
  <v-app :theme="theme">
    ...
    <v-navigation-drawer v-model="drawer" :permanent="pinned" :temporary="!pinned">
      ...
      <v-list-item link title="Queue" @click="showTab('queue')"
        ><template v-slot:prepend>
          <v-icon icon="mdi-human-queue"></v-icon>
        </template>
      </v-list-item>
      <v-list-item link title="Playlists" @click="showTab('myplaylists')"
        ><template v-slot:prepend>
          <v-icon icon="mdi-playlist-play"></v-icon>
        </template>
      </v-list-item>
      <v-list-item link title="Albums" @click="showTab('savedalbums')"
        ><template v-slot:prepend>
          <v-icon icon="mdi-playlist-play"></v-icon>
        </template>
      </v-list-item>
      <v-list-item link title="Tracks" @click="showTab('savedtracks')"
        ><template v-slot:prepend>
          <v-icon icon="mdi-music"></v-icon>
        </template>
      </v-list-item>
      <v-list-item link title="Podcasts" @click="showTab('savedpodcasts')"
        ><template v-slot:prepend>
          <v-icon icon="mdi-podcast"></v-icon>
        </template>
      </v-list-item>
      <v-list-item link title="Episodes" @click="showTab('savedepisodes')"
        ><template v-slot:prepend>
      ...
      <v-list-item link title="Control" @click="showTab('radio')"
        ><template v-slot:prepend>
