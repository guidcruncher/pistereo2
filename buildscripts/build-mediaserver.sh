...
mkdir -p ./build/mediaserver/mpv
mkdir -p ./build/mediaserver/librespot

if [ -f "../config/.env" ]; then
cat  ../config/.env > ./build/.env
fi

cp ./mediaserver/librespot/* ./build/mediaserver/librespot
cp ./mediaserver/mpv/* ./build/mediaserver/mpv

chmod +x ./build/mediaserver/librespot/*.sh
chmod +x ./build/mediaserver/mpv/*.sh
